function load() {
    $.getJSON("temp_result.json", function (data) {
        ...
        //var first_report = data[0].summary;
        //var num_tests = first_report.unknown + first_report.passed + first_report.warned + first_report.failed + first_report.skipped;
