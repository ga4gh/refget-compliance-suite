...
from unittests.constants import GOOD_SERVER_V1_URL
from unittests.mock_servers.servers import GoodRefgetServerV1

good_server_host = GOOD_SERVER_V1_URL.split("://")[1].split(":")[0]
good_server_port = GOOD_SERVER_V1_URL.split("://")[1].split(":")[1].replace("/", "")

app = Flask(__name__)


server = GoodRefgetServerV1()
