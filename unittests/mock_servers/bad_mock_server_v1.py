...
from unittests.constants import BAD_SERVER_V1_URL
from unittests.mock_servers.servers import BadRefgetServerV1

bad_server_host = BAD_SERVER_V1_URL.split("://")[1].split(":")[0]
bad_server_port = BAD_SERVER_V1_URL.split("://")[1].split(":")[1].replace("/", "")

app = Flask(__name__)


server = BadRefgetServerV1()
